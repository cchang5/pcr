...
\begin{figure}[h]{
		\includegraphics[width=0.49\textwidth]{plots/figures/logGBF.pdf}
		\caption{Normalized log Bayes Factor for the preferred fit region. The model marked by the solid star ($n$-state = 2) is more likely to reproduce the data by two orders of magnitude over the $n$-state = 3 and 4, as indicated by the normalized Bayes Factor.}
		\label{fig:logGBF}
}\end{figure}

\subsubsection{Finite volume dependence}
